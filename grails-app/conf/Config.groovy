...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'arduito.Usuario'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'arduito.UsuarioPerfil'
grails.plugins.springsecurity.authority.className = 'arduito.Perfil'

grails.plugins.springsecurity.roleHierarchy = '''
   ROLE_ARDUITO > ROLE_ADMIN
