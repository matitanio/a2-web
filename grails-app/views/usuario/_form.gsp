 ...
 <div class="row">
 	<div class="span4">
		...
		<div class="control-group fieldcontain ${hasErrors(bean: usuarioInstance, field: 'rol', 'error')} ">
			<label for="rol" class="control-label"><g:message code="usuario.cuenta.label" default="Rol" /></label>
			<div class="controls">
				<g:select id="rol" name="rol" from="${arduito.Perfil.obtenerPerfilesVisibles(sec.loggedInUserInfo(field:'username').toString())}" optionKey="id" value="${usuarioInstance.username!=null?usuarioInstance.perfil.id:''}" class="many-to-one" noSelection="['null': 'seleccione el perfil']"/>
